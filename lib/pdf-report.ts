...
<head>
  ...
  <title>FairRent Rent Fairness Report</title>
  <style>
    @media print {
...
<body>
  ...
  <div class="summary-grid">
    ...
    <div class="summary-item">
      ...
      <div class="summary-value" style="color: ${data.estimatedFairRent < data.currentRent ? "#16a34a" : "#1f2937"};">
        ${formatCurrency(data.estimatedFairRent)}
      </div>
    </div>
    <div class="summary-item">
  ...
  <!-- Footer -->
  <div class="footer">
    <p>This report was generated by FairRent on ${escapeHtml(data.generatedDate)}.</p>
    ...
    <p style="margin-top: 8px; color: #2563eb; font-weight: 500;">FairRent | fairrent.app</p>
  </div>
</body>
</html>`;
}
